...
## Input Contract
- Required: visual behavior target, affected render paths, and simulation-render boundaries.
- Preferred: architecture constraints, core data contracts, and known artifact/performance risks.
- If update rules are unclear: define assumptions and request missing constraints.

## Output Contract
- Deliver rendering changes with explicit rebuild/invalidation and data-flow rules.
- Preserve simulation-to-render ownership boundaries.
- Provide validation steps and rendering risk classification.
